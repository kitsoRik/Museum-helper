import { LOAD_FAVORITES_STARTED, LOAD_FAVORITES_SUCCESS, LOAD_FAVORITES_FAILED, CHANGE_FAVORITES_GROUPS, SET_EDITABLE, FAVORITE_GROUP_ADDED, FAVORITE_GROUP_DELETED, MOVE_GROUP, REMOVE_PICTURE_INFO_PENDING, REMOVE_PICTURE_INFO_SUCCESS, REMOVE_PICTURE_INFO_FAIL } from "../actions/favoritesActions";
import { IS_LOADING, LOADED, NOT_LOADED, DIRECTION_DOWN, DIRECTION_UP } from "../constants";
import { PICTURE_FROM_FAVOTIRES_DELETED, DELETE_PICTURE_SUCCESS } from "../actions/picturesActions";
