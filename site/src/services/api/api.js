...
const getUserData = () => AxiosPost(`/getData`);
...
const unlogin = () => AxiosPost(`/unlogin`);

const getRegisterIn = (username, email, password, passwordConfirm) =>
	AxiosPost(`/registerIn`, { username, email, password, passwordConfirm });

const verifyEmail = (link) => AxiosPost("/verifyEmail", { link });

const verifyEmailAgain = (email) => AxiosPost("/verifyEmailAgain", { email });

const getMuseum = (museumId) => AxiosPost(`/getMuseum`, { museumId });

const getMuseums = () => AxiosPost(`/getMuseums`);

const addMuseum = (name, location) =>
	AxiosPost(`/addMuseum`, { name, location });

const removeMuseum = (museumId) => AxiosPost(`/removeMuseum`, { museumId });
...
const getPictureData = (id) => AxiosPost(`/getPictureData`, { id });
...
const removePictureInfo = (id) => AxiosPost(`/removePictureInfo`, { id });

const getFavotires = () => AxiosPost(`/getFavorites`);

const saveFavotires = ({ groups }) => AxiosPost(`/saveFavorites`, { groups });
...
const deleteFavoriteGroup = (id) => AxiosPost(`/deleteFavoriteGroup`, { id });
