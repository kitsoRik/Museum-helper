...
exports.getMuseumsByNamePattern = (name) => new Promise((resolve, reject) => {
...
exports.newReleaseByMuseumId = (museumId) => new Promise((resolve, reject) => {
    ...
    getLastReleaseIdByMuseumId(museumId)
        ...
        .then(() => setReleaseIdByMuseumId(museumId, releaseId + 1, releaseId))
...
const addMuseum = (userId, name, location) => new Promise((resolve, reject) => {
...
const getLastReleaseIdByMuseumId = (museumId) => new Promise((resolve, reject) => {
...
const setReleaseIdByMuseumId = (museumId, releaseId, lastReleaseId) => new Promise((resolve, reject) => {
    db.run(`UPDATE museums
            SET update_id=? 
...
const getLastMuseumByData = (userId, name, location) => new Promise((resolve, reject) => {
